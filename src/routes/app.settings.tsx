...
function ProfileSection() {
  ...
  async function saveProfile() {
    ...
    try {
      const updated = (await api.updateProfile({ username, email })) as typeof currentUser;
  ...
  return (
    <Card title="Your profile" description="Manage your account details and password.">
      <div className="flex items-center gap-4 pb-5">
        ...
        <div className="min-w-0">
          <div className="text-base font-semibold">{currentUser.username || currentUser.name}</div>
